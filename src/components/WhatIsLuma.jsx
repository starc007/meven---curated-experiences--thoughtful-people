      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <FeatureItem 
            ...
            description="Luma prioritizes intent and fit over first-come-first-serve. Hosts review applications to curate balanced, engaged rooms."
          />
        ...
        >
          ...
          <motion.p 
            ...
            variants={scrollReveal}
          >
            We believe in human curation over endless feeds. Luma is built for hosts who care about creating memorable experiences and guests who value quality over quantity.
          </motion.p>
        </motion.div>
